...
<div className='fixed right-0 top-0  h-full  flex justify-end items-end lg:justify-center lg:items-center  z-50 '>
   <div className="links   p-4 lg:p-5    mt-10    flex flex-col  justify-start  gap-5 sm:gap-10    w-max  items-center   rounded-r-[3.5rem]">
